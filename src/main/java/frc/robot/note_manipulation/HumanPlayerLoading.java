...
public class HumanPlayerLoading extends ParallelCommandGroup {
    public HumanPlayerLoading(Conveyor conveyor, Shooter shooter, Intake intake, NoteSystemConfiguration conf, JoystickRequester req, JoystickConfiguration j_conf) {
        ...
        ShooterSetRPM shooter_rpm = new ShooterSetRPM(shooter, 0, HoldMode.Indefinite);
